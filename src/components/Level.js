...
// --------------------level2---------------------------
// level2 Top-Down
const moveTop2Down = (board, colIndex) => {
...
// level2 Down-Top
const moveDown2Top = (board, colIndex) => {
	for(let i = 1; i <= board.length - 2; i++) {
		if(board[i][colIndex] === 0) {
...
// level2 Right-Left
const moveRight2Left = (board, rowIndex) => {
...
// level2 Left-Right
const moveLeft2Right = (board, rowIndex) => {
	for(let i = 1; i <= board[rowIndex].length - 2; i++) {
		if(board[rowIndex][i] === 0) {
...
const move3CenterLeftRight = (board, rowIndex, colIndex) => {
...
const move3CenterTopDown = (board, colIndex, rowIndex) => {
...
const move3OutLeftRight = (board, rowIndex, colIndex) => {
	if(colIndex < board[rowIndex].length / 2) {
		for(let i = 1; i < board[rowIndex].length / 2; i++) {
			if(board[rowIndex][i] === 0) {
				for(let j = i; j < board[rowIndex].length / 2; j++) {
...
const move3OutTopDown = (board, rowIndex, colIndex) => {
	if(rowIndex < board.length / 2 - 0.5) {
		for(let i = 1; i < board.length / 2 - 0.5; i++) {
			if(board[i][colIndex] === 0) {
...
// ------------------------endLevel3------------------------------
// 
export { moveTop2Down, moveRight2Left, moveLeft2Right, move3CenterLeftRight, move3CenterTopDown, move3OutLeftRight, move3OutTopDown };
